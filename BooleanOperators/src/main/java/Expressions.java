...
public class Expressions {
    ...
    public static void main(String[] args){
        ...
        System.out.println(express.returnBoolean(false));
        System.out.println(express.returnNot(false));
        System.out.println(express.returnAnd(false, false));
        System.out.println(express.returnOr(false, false));
    }
